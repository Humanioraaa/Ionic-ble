...
import { BleClient, BleClientInterface } from '@capacitor-community/bluetooth-le';
...
export class BleService {
  ...
  constructor(public ble: BleClient, private toastCtrl: ToastController,private ngZone: NgZone, private alertCtrl: AlertController) {
